...
class ShopifyAdapter:
    ...
    ITEMS_MAP = {
        ...
        # price - separate unit prices from line totals to prevent semantic confusion
        'lineitem price': 'unit_price', 'price': 'unit_price', 'item price': 'unit_price',
        'unit price': 'unit_price', 'unit_price': 'unit_price',
        # line totals - separate field to avoid overwriting unit prices
        'item_total': 'line_item_total', 'subtotal': 'line_item_total', 'line total': 'line_item_total',
        # discount
    ...
    def normalize_items(cls, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Coerce numeric fields - now includes both unit_price and line_item_total
        for numc in ['quantity', 'unit_price', 'line_item_total', 'line_item_discount']:
